...
```
The country names with more than one iso3 code. These are CHANISL, GBM, KOS, and NLD CURACAO. Two country names that were stated in the hint, appeared within my output.
...
```
This figure suggests for the most part tell the same story as the CO2 plot. However, India and China's CO2 per capita are not nearly as steep, along with the data being more spread out on the plot. As the US is isolated at the top, though keeping it's same shape.
...
```
I used data from 2016 instead of 2019 because in 2019, there seemed to be a lot of missing data. I checked this in the class discord and it was ok'd by the professor (as long as we put a sentence about it of course).
